    ...
    public static Map<String, Command> getOwnerCommands() {
        ...
        ownerCommands.put("ban", (event, args) -> {
            ...
            if(BotUtils.isBanned(args.get(0))) {
                ...
                builder.withDescription(BotUtils.CLIENT.getUserByID(Long.parseUnsignedLong(args.get(0))).getName() + " is already banned.");
                RequestBuffer.request(() -> event.getChannel().sendMessage(builder.build()));
                return;
            }
            ...
            try {
                ...
                builder.withDescription(BotUtils.CLIENT.getUserByID(Long.parseUnsignedLong(args.get(0))).getName() + " is now banned.");
            }catch(Exception e){
                builder.withColor(255, 0, 0);
                e.printStackTrace();
                builder.withTitle("Error Banning");
        ...
        ownerCommands.put("unban", (event, args) -> {
            ...
            if(!BotUtils.isBanned(args.get(0))) {
                ...
                builder.withDescription(BotUtils.CLIENT.getUserByID(Long.parseUnsignedLong(args.get(0))).getName() + " is not banned.");
                RequestBuffer.request(() -> event.getChannel().sendMessage(builder.build()));
                return;
            }
            ...
            try {
                ...
                builder.withDescription(BotUtils.CLIENT.getUserByID(Long.parseUnsignedLong(args.get(0))).getName() + " has been unbanned.");
            }catch(Exception e){
                builder.withColor(255, 0, 0);
                e.printStackTrace();
                builder.withTitle("Error Unbanning");
