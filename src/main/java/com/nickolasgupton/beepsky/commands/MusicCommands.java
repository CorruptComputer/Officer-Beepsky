...
import com.nickolasgupton.beepsky.music.TrackScheduler;
...
public class MusicCommands {
  ...
  /**
   * Music Commands are defined here.
   *
   * @return returns the map of Music Commands
   */
  public static Map<String, Command> getMusicCommands() {
    ...
    musicCommands.put("listqueue", (event, args) -> {
      ...
      String str = MusicHelper.formatQueueOutput(musicManager.getScheduler().getQueue());
